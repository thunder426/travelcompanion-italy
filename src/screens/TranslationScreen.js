...
import { translateImage } from '../services/claudeApi';
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.permissionText}>
          Camera access is needed to translate text.
        </Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Point at any text — menus, signs, museum plaques — and get an instant translation with context.
      </Text>
      ...
      {loading ? (
        ...
        <ScrollView style={styles.resultContainer} showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity style={styles.button} onPress={() => { setResult(null); setCameraActive(true); }}>
            <Text style={styles.buttonText}>Translate Another</Text>
          </TouchableOpacity>
        </ScrollView>
      ) : (
